                ...
                <div className="glass-panel" style={{ flex: 1 }}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div style={{ position: 'relative', marginBottom: '8px' }}>
                            <input type={showPassword ? "text" : "password"} className="input-field" value={formData.password} onChange={e => setFormData({...formData, password: e.target.value})} required={!editingUserId} style={{marginBottom: 0, width: '100%', boxSizing: 'border-box'}} />
                            <button 
                                type="button" 
